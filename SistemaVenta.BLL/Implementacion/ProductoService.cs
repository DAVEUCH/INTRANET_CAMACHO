...
namespace SistemaVenta.BLL.Implementacion
{
    ...
    { 
        ...
        public async Task<Producto> Crear(Producto entidad, Stream imagen = null)
        {
            ...
            try
            {
                ...
                if (imagen != null) {
                    string urlImage = await _fireBaseServicio.SubirStorage(imagen, "carpeta_producto");
        ...
        public async Task<Producto> Editar(Producto entidad, Stream imagen = null)
        {
            ...
            try
            {
                ...
                producto_para_editar.NombreImagen = entidad.NombreImagen;


                if (imagen != null) {
                    string urlImagen = await _fireBaseServicio.SubirStorage(imagen, "carpeta_producto");
        ...
        public async Task<bool> Eliminar(int idProducto)
        {
            try
            {
                ...
                if (respuesta)
                    await _fireBaseServicio.EliminarStorage("carpeta_producto");
