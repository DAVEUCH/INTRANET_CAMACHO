...
{
    public partial class ESolicitudCotizacion3
    {
        ...
        public string SolicitudCotizacion3EstadoAprobacion { get; set; } = null!;
        public int SolicitudCotizacion3IdcpInventario { get; set; }
        public bool SolicitudCotizacion3CpInventarioCostoPromedio { get; set; }
        public int SolicitudCotizacion3CpInventarioCostoPromedioCantidad { get; set; }
        public int SolicitudCotizacion3CpInventarioCostoPromedioMonto { get; set; }
        public bool SolicitudCotizacion3CpInventarioCostoUltimaCompra { get; set; }
        public bool SolicitudCotizacion3CpInventarioCostoReferencia { get; set; }
        public bool SolicitudCotizacion3CpInventarioCostoParalelo { get; set; }
        public decimal SolicitudCotizacion3CpInventarioPeso { get; set; }
        public decimal SolicitudCotizacion3CpInventarioVolumen { get; set; }
        public bool SolicitudCotizacion3CpInventarioSobregirarStockDisponible { get; set; }
        public int SolicitudCotizacion3CpInventarioIdtipoOperacion { get; set; }
        public bool SolicitudCotizacion3CpInventarioSugerenciaCompra { get; set; }
        public string SolicitudCotizacion3CpInventarioTipoCpInventario { get; set; } = null!;
        public int SolicitudCotizacion3CpInventarioMovStockContable { get; set; }
        public int SolicitudCotizacion3CpInventarioMovStockFisico { get; set; }
        public int SolicitudCotizacion3CpInventarioMovStockPorEntregar { get; set; }
        public int SolicitudCotizacion3CpInventarioMovStockPorRecibir { get; set; }
        public int SolicitudCotizacion3CpInventarioIdalmacen { get; set; }
        public int SolicitudCotizacion3CpInventarioId { get; set; }
        public bool SolicitudCotizacion3RequiereAprobacion { get; set; }
        public string? SolicitudCotizacion3EstadoRemision { get; set; }
