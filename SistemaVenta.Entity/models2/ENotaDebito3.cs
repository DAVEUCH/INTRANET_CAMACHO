...
{
    public partial class ENotaDebito3
    {
        ...
        public int NotaDebitoPkid { get; set; }
        public string NotaDebitoDocIdentidad { get; set; } = null!;
        public int NotaDebitoIdcpInventario { get; set; }
        public int NotaDebitoCpInventarioId { get; set; }
        public int? NotaDebitoCpInventarioIdalmacen { get; set; }
        public int? NotaDebitoCpInventarioIdtipoOperacion { get; set; }
        public int? NotaDebitoCpInventarioMovStockContable { get; set; }
        public int? NotaDebitoCpInventarioMovStockFisico { get; set; }
        public int? NotaDebitoCpInventarioMovStockPorEntregar { get; set; }
        public int? NotaDebitoCpInventarioMovStockPorRecibir { get; set; }
        public bool? NotaDebitoCpInventarioCostoPromedio { get; set; }
        public int? NotaDebitoCpInventarioCostoPromedioCantidad { get; set; }
        public int? NotaDebitoCpInventarioCostoPromedioMonto { get; set; }
        public bool? NotaDebitoCpInventarioCostoUltimaCompra { get; set; }
        public bool? NotaDebitoCpInventarioCostoReferencia { get; set; }
        public bool? NotaDebitoCpInventarioCostoParalelo { get; set; }
        public string? NotaDebitoCpInventarioTipoCpInventario { get; set; }
        public decimal? NotaDebitoCpInventarioPeso { get; set; }
        public decimal? NotaDebitoCpInventarioVolumen { get; set; }
        public bool? NotaDebitoCpInventarioSobregirarStockDisponible { get; set; }
        public bool? NotaDebitoCpInventarioSugerenciaCompra { get; set; }
        ...
        public int NotaDebito3CpInventarioId { get; set; }
        public int? NotaDebito3CpInventarioMovStockFisico { get; set; }
        public int? NotaDebito3CpInventarioMovStockContable { get; set; }
        public int? NotaDebito3CpInventarioMovStockPorEntregar { get; set; }
        public int? NotaDebito3CpInventarioMovStockPorRecibir { get; set; }
        public bool? NotaDebito3CpInventarioSobregirarStockDisponible { get; set; }
        public bool? NotaDebito3CpInventarioCostoPromedio { get; set; }
        public bool? NotaDebito3CpInventarioCostoUltimaCompra { get; set; }
        public bool? NotaDebito3CpInventarioCostoParalelo { get; set; }
    }
}
