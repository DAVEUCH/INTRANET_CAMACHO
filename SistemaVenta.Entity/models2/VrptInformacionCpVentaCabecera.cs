...
{
    public partial class VrptInformacionCpVentaCabecera
    {
        ...
        public decimal? ComprobanteTotalIgv { get; set; }
        public decimal ComprobanteTotal { get; set; }
        public DateTime ComprobanteFechaVencimiento { get; set; }
        public string ComprobanteModalidaCreditoDescripcion { get; set; } = null!;
        ...
        public string ComprobanteDireccion { get; set; } = null!;
