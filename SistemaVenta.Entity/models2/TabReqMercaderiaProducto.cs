...
{
    public partial class TabReqMercaderiaProducto
    {
        ...
        public int? EsDistrib { get; set; }
        public int? Año { get; set; }
        public int? Mes { get; set; }
        public int? IdreqAnt { get; set; }
        public int? IdreqSig { get; set; }
        public int? IddistriAnt { get; set; }
        public int? IddistriSig { get; set; }
