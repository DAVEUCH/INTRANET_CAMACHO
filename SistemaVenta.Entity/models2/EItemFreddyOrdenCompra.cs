...
{
    public partial class EItemFreddyOrdenCompra
    {
        ...
        public decimal ItemsItemOrdenCompraPrecioLista { get; set; }
        public decimal ItemsItemOrdenCompraDescuentoA { get; set; }
        public decimal ItemsItemOrdenCompraDescuentoB { get; set; }
        public decimal ItemsItemOrdenCompraDescuentoC { get; set; }
        public decimal ItemsItemOrdenCompraDescuentoD { get; set; }
        public decimal ItemsItemOrdenCompraDescuentoE { get; set; }
        public decimal ItemsItemOrdenCompraBalanceEntrega { get; set; }
        public decimal ItemsItemOrdenCompraBalanceFacturacion { get; set; }
        public bool ItemsItemOrdenCompraActualizarListaPreciosProveedor { get; set; }
        public decimal ItemsItemOrdenCompraCantidadAentregar { get; set; }
        public decimal ItemsItemOrdenCompraCostoParalelo { get; set; }
        ...
        public decimal ItemsItemOrdenCompraCantidadPedida { get; set; }
