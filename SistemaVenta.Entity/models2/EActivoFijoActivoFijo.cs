...
{
    public partial class EActivoFijoActivoFijo
    {
        ...
        public int ProductoActivoFijoActivoFijoId { get; set; }
        public DateTime ProductoActivoFijoActivoFijoFechaAdquisicion { get; set; }
        public DateTime ProductoActivoFijoActivoFijoFechaActivacion { get; set; }
        public bool ProductoActivoFijoActivoFijoActivado { get; set; }
        public string ProductoActivoFijoActivoFijoNumeroSerie { get; set; } = null!;
        public decimal ProductoActivoFijoActivoFijoPorcentajeDepreciacion { get; set; }
        public bool ProductoActivoFijoActivoFijoTangible { get; set; }
        public int ProductoActivoFijoActivoFijoIdmetodoDepreciacion { get; set; }
        public int ProductoActivoFijoActivoFijoIdcuentaContable { get; set; }
        public int ProductoActivoFijoActivoFijoIdubicacion { get; set; }
        public string ProductoActivoFijoActivoFijoModelo { get; set; } = null!;
        public string ProductoImagenProducto { get; set; } = null!;
        public int? ProductoActivoFijoActivoFijoIdcuentaContable2 { get; set; }
        public int? ProductoActivoFijoActivoFijoIdcuentaContable3 { get; set; }
    }
}
