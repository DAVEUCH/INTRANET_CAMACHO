...
{
    public partial class ETipoCpConteo
    {
        ...
        public int TipoCpConteoId { get; set; }
        public int TipoCpConteoIdalmacen { get; set; }
        public bool TipoCpConteoRestringirAlmacen { get; set; }
