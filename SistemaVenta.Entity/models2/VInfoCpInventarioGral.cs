...
{
    public partial class VInfoCpInventarioGral
    {
        ...
        public int ItemProductoBalanceEntrega { get; set; }
        public int ItemProductoBalanceFacturacion { get; set; }
        public decimal ItemProductoPrecioLista { get; set; }
        public int ItemProductoDescuentoAplicado { get; set; }
        public int ItemProductoDescuentoFijo { get; set; }
        public int ItemProductoCantidadPedida { get; set; }
        ...
        public int AplicaPercepcion { get; set; }
        public int PorcentajeDetraccion { get; set; }
        public int MontoDetraccion { get; set; }
        ...
        public string? ComprobanteRelacionadoNumero2 { get; set; }
        public string? ComprobanteRelacionadoAbreviacion2 { get; set; }
    }
}
