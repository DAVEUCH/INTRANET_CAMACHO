...
{
    public partial class ETipoVoucher
    {
        ...
        public int TipoVoucherId { get; set; }
        public string TipoVoucherTipoOperacion { get; set; } = null!;
        public bool TipoVoucherAjusteDiferenciaTipoCambio { get; set; }
