...
namespace SistemaVenta.Entity.models2
{
    public partial class EItemDua
    {
        ...
        public int ItemsItemDuaId { get; set; }
        public decimal ItemsItemDuaCantidadAentregar { get; set; }
        public decimal ItemsItemDuaValorIncoterm { get; set; }
        public decimal ItemsItemDuaValorFlete { get; set; }
        public decimal ItemsItemDuaValorSeguro { get; set; }
        public decimal ItemsItemDuaValorCif { get; set; }
        public decimal ItemsItemDuaValorAjuste { get; set; }
        public decimal ItemsItemDuaValorAduana { get; set; }
        public decimal ItemsItemDuaPorcentajeImpuestoDua { get; set; }
        public int ItemsItemDuaBalanceImportacion { get; set; }
        public decimal ItemsItemDuaMontoArancel { get; set; }
        public decimal ItemsItemDuaMontoImpuesto { get; set; }
        public decimal ItemsItemDuaTotalCif { get; set; }
        public decimal ItemsItemDuaTotalIncoterm { get; set; }
        ...
        public bool ValorUnitario { get; set; }
        ...
        public decimal ItemsItemDuaPorcentajePercepcion { get; set; }
        public decimal ItemsItemDuaTotalIgv { get; set; }
        public decimal ItemsItemDuaTotalFob { get; set; }
        public decimal ItemsItemDuaTotalPercepcion { get; set; }
        public decimal ItemsItemDuaTotalServicioDespacho { get; set; }
        public decimal ItemsItemDuaTotalArancel { get; set; }
        public decimal ItemsItemDuaValorServicioDespacho { get; set; }
        public decimal ItemsItemDuaValorFob { get; set; }
