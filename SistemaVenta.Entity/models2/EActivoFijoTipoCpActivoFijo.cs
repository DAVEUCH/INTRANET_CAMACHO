...
{
    public partial class EActivoFijoTipoCpActivoFijo
    {
        ...
        public int ActivoFijoTipoCpActivoFijoPkid { get; set; }
        public int ActivoFijoTipoCpActivoFijoIdalmacen { get; set; }
        public bool ActivoFijoTipoCpActivoFijoRestringirAlmacen { get; set; }
        public string? ActivoFijoTipoCpActivoFijoTipoMovimiento { get; set; }
        public bool ActivoFijoTipoCpActivoFijoRequiereTransportista { get; set; }
        public bool ActivoFijoTipoCpActivoFijoImportacion { get; set; }
        public bool? ActivoFijoTipoCpActivoFijoActivacionDeActivo { get; set; }
