...
{
    public partial class ERequerimientoMercaderium
    {
        public int RequerimientoMercaderiaPkid { get; set; }
        public int RequerimientoMercaderiaIdalmacenEntrada { get; set; }
        public int RequerimientoMercaderiaIdalmacenSalida { get; set; }
        public int RequerimientoMercaderiaIdalmacenTransito { get; set; }
        public string RequerimientoMercaderiaEstadoEntrega { get; set; } = null!;
        public string RequerimientoMercaderiaEstadoRecepcion { get; set; } = null!;
