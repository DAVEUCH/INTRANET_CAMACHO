...
{
    public partial class ECpRetencion3
    {
        ...
        public int CpRetencionId { get; set; }
        public decimal CpRetencionPorcentajeRetencion { get; set; }
        public decimal CpRetencionMontoMinimo { get; set; }
