...
{
    public partial class ECpImportacion2
    {
        ...
        public int CpImportacion2CpInventarioSalidaId { get; set; }
        public int CpImportacion2CpInventarioSalidaIdcp { get; set; }
        public int CpImportacion2CpInventarioSalidaIdalmacen { get; set; }
        public int CpImportacion2CpInventarioSalidaMovStockContable { get; set; }
        public int CpImportacion2CpInventarioSalidaMovStockFisico { get; set; }
        public int CpImportacion2CpInventarioSalidaMovStockPorEntregar { get; set; }
        public int CpImportacion2CpInventarioSalidaMovStockPorRecibir { get; set; }
        public bool CpImportacion2CpInventarioSalidaCostoPromedio { get; set; }
        public int CpImportacion2CpInventarioSalidaCostoPromedioCantidad { get; set; }
        public int CpImportacion2CpInventarioSalidaCostoPromedioMonto { get; set; }
        public bool CpImportacion2CpInventarioSalidaCostoUltimaCompra { get; set; }
        public bool CpImportacion2CpInventarioSalidaCostoReferencia { get; set; }
        public bool CpImportacion2CpInventarioSalidaCostoParalelo { get; set; }
        public string CpImportacion2CpInventarioSalidaTipoCpInventario { get; set; } = null!;
        public decimal CpImportacion2CpInventarioSalidaPeso { get; set; }
        public decimal CpImportacion2CpInventarioSalidaVolumen { get; set; }
        public bool CpImportacion2CpInventarioSalidaSobregirarStockDisponible { get; set; }
        public bool CpImportacion2CpInventarioSalidaSugerenciaCompra { get; set; }
        public int CpImportacion2CpInventarioSalidaIdtipoOperacion { get; set; }
        ...
        public int CpImportacion2IdcpInventarioSalida { get; set; }
