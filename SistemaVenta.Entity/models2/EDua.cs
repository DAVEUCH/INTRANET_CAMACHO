...
namespace SistemaVenta.Entity.models2
{
    public partial class EDua
    {
        ...
        public int DuaPkid { get; set; }
        public int DuaIdimpuestoDua { get; set; }
        public int DuaIdincoterm { get; set; }
        public string DuaEstadoImportacion { get; set; } = null!;
        public int DuaIdalmacen { get; set; }
        public string IdtipoAsociado { get; set; } = null!;
        public decimal DuaTotalIncoterm { get; set; }
        public decimal DuaTotalFlete { get; set; }
        public decimal DuaTotalSeguro { get; set; }
        public decimal DuaTotalCif { get; set; }
        public decimal DuaTotalAjuste { get; set; }
        public decimal DuaTotalAduana { get; set; }
        public decimal DuaTotalArancel { get; set; }
        public DateTime FechaTipoCambio { get; set; }
        public decimal TipoCambio { get; set; }
        public bool Revisado { get; set; }
        public decimal DuaTotalFob { get; set; }
        public decimal DuaPorcentajePercepcion { get; set; }
        public decimal DuaTotalServicioDespacho { get; set; }
        public decimal DuaTotalPercepcion { get; set; }
        public string DuaSerieDependenciaAduanera { get; set; } = null!;
