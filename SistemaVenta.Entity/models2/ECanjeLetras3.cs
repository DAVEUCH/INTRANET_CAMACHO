...
{
    public partial class ECanjeLetras3
    {
        public int CanjeLetrasPkid { get; set; }
        public int CanjeLetrasIdbanco { get; set; }
        public string CanjeLetrasDireccion { get; set; } = null!;
        public decimal CanjeLetrasTotalCanjear { get; set; }
        public int CanjeLetrasIdmodalidadCredito { get; set; }
        public int CanjeLetrasIdcptoOperacionLetra { get; set; }
        public int CanjeLetrasIdtipoLetra { get; set; }
        public int CanjeLetrasIdestado { get; set; }
