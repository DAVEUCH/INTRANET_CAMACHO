...
{
    public partial class ETipoCotizacion
    {
        ...
        public bool TipoCotizacionRequiereCliente { get; set; }
        public int TipoCotizacionIdalmacen { get; set; }
        public bool TipoCotizacionRestringirAlmacen { get; set; }
