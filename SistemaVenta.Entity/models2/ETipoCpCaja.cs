...
{
    public partial class ETipoCpCaja
    {
        ...
        public int TipoCpCajaId { get; set; }
        public int TipoCpCajaIdcaja { get; set; }
        public bool TipoCpCajaRestringirCaja { get; set; }
        public string TipoCpCajaTipoMovimiento { get; set; } = null!;
        public bool TipoCpCajaRestringirDocumentoPersona { get; set; }
        public bool TipoCpCajaRestringirCajaCabecera { get; set; }
        public bool TipoCpCajaPagoDetraccion { get; set; }
        ...
        public bool TipoCpCajaAmortizacionTotal { get; set; }
        public bool PermitirFechasPasadas { get; set; }
        public bool TipoCpCajaRestringirAplicacionDocumentos { get; set; }
