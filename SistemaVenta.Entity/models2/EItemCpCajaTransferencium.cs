...
{
    public partial class EItemCpCajaTransferencium
    {
        ...
        public int ItemsItemCpCajaTransferenciaIdcajaEntrada { get; set; }
        public int ItemsItemCpCajaTransferenciaIdcajaSalida { get; set; }
        public decimal ItemsItemCpCajaTransferenciaDiferenciaTipoCambio { get; set; }
        public decimal ItemsItemCpCajaTransferenciaPerdidaPorDiferenciaTipoCambio { get; set; }
        public decimal ItemsItemCpCajaTransferenciaGananciaPorDiferenciaTipoCambio { get; set; }
        public decimal ItemsItemCpCajaTransferenciaTipoCambio { get; set; }
        ...
        public bool ItemsItemCpCajaTransferenciaAplicaConfiguracion { get; set; }
        public int ItemsItemCpCajaTransferenciaIditemConfiguracionTransferencia { get; set; }
