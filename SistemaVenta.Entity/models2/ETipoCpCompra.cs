...
{
    public partial class ETipoCpCompra
    {
        ...
        public int TipoCpCompraId { get; set; }
        public int TipoCpCompraIdalmacen { get; set; }
        public bool TipoCpCompraRestringirAlmacen { get; set; }
        public int IdtipoComprobantePago { get; set; }
        public bool EsComprobantePago { get; set; }
        public bool TipoCpCompraImportacion { get; set; }
