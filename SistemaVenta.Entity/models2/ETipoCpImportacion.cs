...
{
    public partial class ETipoCpImportacion
    {
        ...
        public int TipoCpImportacionPkid { get; set; }
        public int TipoCpImportacionIdalmacen { get; set; }
        public bool TipoCpImportacionRestringirAlmacen { get; set; }
        public string TipoCpImportacionCriterioProrrateo { get; set; } = null!;
