...
{
    public partial class ETipoCpVentum
    {
        ...
        public int TipoCpVentaId { get; set; }
        public int TipoCpVentaIdalmacen { get; set; }
        public bool TipoCpVentaRequiereCliente { get; set; }
        public bool TipoCpVentaRestringirAlmacen { get; set; }
        public bool TipoCpVentaFueraDeRuta { get; set; }
        public int TipoCpVentaIdtipoDocIdentidad { get; set; }
        public decimal TipoCpVentaMontoMinimo { get; set; }
        public bool TipoCpVentaAplicaDistribucion { get; set; }
        ...
        public bool TipoCpVentaAplicaRedondeo { get; set; }
        public int TipoCpVentaNumeroPrecisionRedondeo { get; set; }
    }
}
