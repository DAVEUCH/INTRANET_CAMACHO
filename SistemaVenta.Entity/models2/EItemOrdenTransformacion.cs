...
{
    public partial class EItemOrdenTransformacion
    {
        ...
        public int ItemsItemOrdenTransformacionPkid { get; set; }
        public decimal ItemsItemOrdenTransformacionBalanceEntrega { get; set; }
