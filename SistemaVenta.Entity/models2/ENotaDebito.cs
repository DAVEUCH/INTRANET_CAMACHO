...
{
    public partial class ENotaDebito
    {
        ...
        public int NotaDebitoCpDistribucionPkid { get; set; }
        public int? NotaDebitoCpDistribucionIdfuerzaVentas { get; set; }
        public int? NotaDebitoCpDistribucionIdzonaVenta { get; set; }
        public int? NotaDebitoCpDistribucionIdzonaReparto { get; set; }
        public int? NotaDebitoCpDistribucionIdgrupoVentas { get; set; }
