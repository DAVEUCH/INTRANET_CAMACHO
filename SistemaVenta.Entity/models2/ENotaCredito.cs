...
{
    public partial class ENotaCredito
    {
        ...
        public int NotaCreditoCpDistribucionPkid { get; set; }
        public int? NotaCreditoCpDistribucionIdfuerzaVentas { get; set; }
        public int? NotaCreditoCpDistribucionIdzonaVenta { get; set; }
        public int? NotaCreditoCpDistribucionIdzonaReparto { get; set; }
        public int? NotaCreditoCpDistribucionIdgrupoVentas { get; set; }
        ...
        public string NotaCreditoDireccion { get; set; } = null!;
        public string NotaCreditoDireccionEntrega { get; set; } = null!;
