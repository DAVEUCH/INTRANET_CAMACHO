...
{
    public partial class VrpteDocumentoPago2Noel
    {
        ...
        public string TipoCpNess { get; set; } = null!;
        public DateTime? FechaNess { get; set; }
        ...
        public int DocumentoPagoPagado { get; set; }
