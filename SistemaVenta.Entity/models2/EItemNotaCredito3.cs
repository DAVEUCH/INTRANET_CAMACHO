...
{
    public partial class EItemNotaCredito3
    {
        ...
        public decimal ItemsItemNotaCreditoBalanceEntregaDevolucion { get; set; }
        public int ItemsItemNotaCreditoIdbonificacion { get; set; }
