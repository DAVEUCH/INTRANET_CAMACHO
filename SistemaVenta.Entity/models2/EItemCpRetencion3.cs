...
{
    public partial class EItemCpRetencion3
    {
        ...
        public int ItemsItemCpCajaIdmoneda { get; set; }
        public int ItemsItemCpCajaIdpersona { get; set; }
        public decimal ItemCpCajaAmortizacion { get; set; }
        public decimal ItemsItemCpCajaAmortizacionPercepcion { get; set; }
        public decimal ItemsItemCpCajaPagoSoles { get; set; }
        public decimal ItemsItemCpCajaPagoDolares { get; set; }
        public decimal ItemsItemCpCajaTotalProvision { get; set; }
        public decimal ItemsItemCpCajaTotalContable { get; set; }
        public decimal ItemsItemCpCajaDiferenciaTipoCambio { get; set; }
        public decimal ItemCpCajaTipoCambio { get; set; }
        public decimal ValorUnitario { get; set; }
        public decimal ItemsItemCpCajaItemCpCajaMontoPago { get; set; }
