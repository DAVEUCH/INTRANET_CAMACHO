...
{
    public partial class ESolicitudCompra
    {
        ...
        public string SolicitudCompraEstadoAprobacion { get; set; } = null!;
        public int SolicitudCompraIdcpInventario { get; set; }
        public bool SolicitudCompraCpInventarioCostoPromedio { get; set; }
        public int SolicitudCompraCpInventarioCostoPromedioCantidad { get; set; }
        public int SolicitudCompraCpInventarioCostoPromedioMonto { get; set; }
        public bool SolicitudCompraCpInventarioCostoUltimaCompra { get; set; }
        public bool SolicitudCompraCpInventarioCostoReferencia { get; set; }
        public bool SolicitudCompraCpInventarioCostoParalelo { get; set; }
        public decimal SolicitudCompraCpInventarioPeso { get; set; }
        public decimal SolicitudCompraCpInventarioVolumen { get; set; }
        public bool SolicitudCompraCpInventarioSobregirarStockDisponible { get; set; }
        public int SolicitudCompraCpInventarioIdtipoOperacion { get; set; }
        public bool SolicitudCompraCpInventarioSugerenciaCompra { get; set; }
        public string SolicitudCompraCpInventarioTipoCpInventario { get; set; } = null!;
        public int SolicitudCompraCpInventarioMovStockContable { get; set; }
        public int SolicitudCompraCpInventarioMovStockFisico { get; set; }
        public int SolicitudCompraCpInventarioMovStockPorEntregar { get; set; }
        public int SolicitudCompraCpInventarioMovStockPorRecibir { get; set; }
        public int SolicitudCompraCpInventarioIdalmacen { get; set; }
        public int SolicitudCompraCpInventarioId { get; set; }
        public bool SolicitudCompraRequiereAprobacion { get; set; }
