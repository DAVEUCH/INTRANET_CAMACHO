...
namespace SistemaVenta.Entity.models2
{
    public partial class ELetra3
    {
        ...
        public int LetraIdbanco { get; set; }
        public int LetraIdestado { get; set; }
        public string LetraDireccion { get; set; } = null!;
        public bool LetraEnBanco { get; set; }
        public string LetraNumeroUnicoBanco { get; set; } = null!;
