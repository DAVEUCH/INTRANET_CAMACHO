...
{
    public partial class EItemCpInventario
    {
        ...
        public int ItemsItemCpInventarioBalanceFacturacion { get; set; }
        public int ItemsItemCpInventarioBalanceDevolucion { get; set; }
        public int ItemsItemCpInventarioBalanceRecepcion { get; set; }
        public int ItemsItemCpInventarioBalanceNacionalizacion { get; set; }
        public decimal ItemsItemCpInventarioCostoParalelo { get; set; }
        public int ItemsItemCpInventarioBalanceEntregaDevolucion { get; set; }
        ...
        public int ItemsItemCpInventarioBalanceSalida { get; set; }
