...
{
    public partial class ECpConfirmarMedioDePagoPropio
    {
        ...
        public int CpConfirmarMedioPagoIdcp { get; set; }
        public int CpConfirmarMedioPagoIdcpCaja { get; set; }
        public int CpConfirmarMedioPagoCpCajaId { get; set; }
        public int CpConfirmarMedioPagoCpCajaIdcaja { get; set; }
        public int CpConfirmarMedioPagoCpCajaIdmoneda { get; set; }
        public int CpConfirmarMedioPagoCpCajaMovSaldoContable { get; set; }
        public int CpConfirmarMedioPagoCpCajaMovSaldoDisponible { get; set; }
        public string CpConfirmarMedioPagoCpCajaTipoCpCaja { get; set; } = null!;
        public decimal CpConfirmarMedioPagoCpCajaTotal { get; set; }
        public bool CpConfirmarMedioPagoCpCajaActualizarNumeracionCheque { get; set; }
        public bool CpConfirmarMedioPagoCpCajaMonedaBase { get; set; }
        public int CpConfirmarMedioPagoCpCajaIdmedioDePago { get; set; }
