...
{
    public partial class ECotizacion3
    {
        ...
        public string Cotizacion3EstadoAprobacion { get; set; } = null!;
        public int Cotizacion3IdcpInventario { get; set; }
        public bool Cotizacion3CpInventarioCostoPromedio { get; set; }
        public int Cotizacion3CpInventarioCostoPromedioCantidad { get; set; }
        public int Cotizacion3CpInventarioCostoPromedioMonto { get; set; }
        public bool Cotizacion3CpInventarioCostoUltimaCompra { get; set; }
        public bool Cotizacion3CpInventarioCostoReferencia { get; set; }
        public bool Cotizacion3CpInventarioCostoParalelo { get; set; }
        public decimal Cotizacion3CpInventarioPeso { get; set; }
        public decimal Cotizacion3CpInventarioVolumen { get; set; }
        public bool Cotizacion3CpInventarioSobregirarStockDisponible { get; set; }
        public int Cotizacion3CpInventarioIdtipoOperacion { get; set; }
        public bool Cotizacion3CpInventarioSugerenciaCompra { get; set; }
        public string Cotizacion3CpInventarioTipoCpInventario { get; set; } = null!;
        public int Cotizacion3CpInventarioMovStockContable { get; set; }
        public int Cotizacion3CpInventarioMovStockFisico { get; set; }
        public int Cotizacion3CpInventarioMovStockPorEntregar { get; set; }
        public int Cotizacion3CpInventarioMovStockPorRecibir { get; set; }
        public int Cotizacion3CpInventarioIdalmacen { get; set; }
        public int Cotizacion3CpInventarioId { get; set; }
        public bool Revisado { get; set; }
        public string? Cotizacion3EstadoFacturacion { get; set; }
