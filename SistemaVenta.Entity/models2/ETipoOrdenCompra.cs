...
{
    public partial class ETipoOrdenCompra
    {
        ...
        public int TipoOrdenCompraId { get; set; }
        public int TipoOrdenCompraIdalmacen { get; set; }
        public bool TipoOrdenCompraRequiereAprobacion { get; set; }
        public bool TipoOrdenCompraConsignacion { get; set; }
        public bool TipoOrdenCompraPredeterminado { get; set; }
        public bool TipoOrdenCompraRestringirAlmacen { get; set; }
        public int IdtipoComprobantePago { get; set; }
        public bool EsComprobantePago { get; set; }
        public bool TipoOrdenCompraImportacion { get; set; }
