...
{
    public partial class TmpvouchersFreddy
    {
        ...
        public string? AsientoGlosa { get; set; }
        public string? AsientoLibroCodigo { get; set; }
        ...
        public string? CargoAbonoGlosa { get; set; }
        public string? PersonaNombre { get; set; }
        public string? SCentroDeCosto { get; set; }
