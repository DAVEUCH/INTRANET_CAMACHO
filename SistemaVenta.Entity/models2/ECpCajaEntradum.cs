...
{
    public partial class ECpCajaEntradum
    {
        ...
        public int CpCajaEntradaIdcaja { get; set; }
        public bool CpCajaEntradaPagoDetraccion { get; set; }
        public decimal CpCajaEntradaTotalSoles { get; set; }
        public decimal CpCajaEntradaTotalDolares { get; set; }
        public bool CpCajaEntradaPercepcionAplicada { get; set; }
        public string CpCajaEntradaConformidadEntrega { get; set; } = null!;
